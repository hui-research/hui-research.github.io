...
leftBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
        if (currentStep === 2) {
            dialogBox.innerHTML = `
            <h2>本研究旨在了解人們在不同情境下的決策行為與情緒反應，並探討個人經歷對其中的影響。</h2>
            <p>——————————</p>
            <h3>稍等我們將一起閱讀知情同意書，若您同意參與研究，您會先填寫問卷，之後進入作業階段，並在結束時收到相關的回饋。</h3>
            `;
        } 
        else if (currentStep === 3) {
            dialogBox.innerHTML = `
            <h2>研究全程約需 30–40 分鐘。</h2>
             <h3>此研究需要一次性完成，請預留充足的時間，並在網路連線穩定的情況下進行。</h3>
             <p>——————————</p>
             <h4>若在過程中畫面超過10分鐘無回應，系統將視為中止，並跳轉至提醒視窗。當然，您在過程中也可以隨時選擇中止研究，我們會尊重您的決定。</h4>
            `;
        } 
        else if (currentStep === 4) {
            dialogBox.innerHTML = `
            <h2>當您準備好時，請點擊「開始」按鈕。</h2>
            <h3>研究將正式開始！</h3>
            `;
          ...
          dialogBox.innerHTML = `
          <h2>您是否年滿十八歲？</h2>
          <h3>（本研究對象為十八歲以上成人，未滿十八歲者將未能參與，感謝您的興趣參與和體諒！）</h3>
          `;
          ...
          <h4>在作答過程中,您可以視需要短暫休息,但若填寫時間超過60分鐘,或對部分問題感到猶豫,歡迎隨時來信聯繫我們協助。</h4>
          <h4>本問卷無需過度深思或追求完美答案,依據您的第一直覺作答即可。</h4>
          <h4>若對問卷內容有任何疑問,建議先行記錄,並於研究結束後與我們反饋。</h4>
          <h4>————————————</h4>
          <h3>準備好後,請點擊「下一步」開始作答。</h3>
          `;
